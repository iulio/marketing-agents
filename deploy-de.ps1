# deploy-germany.ps1 - AZURE GERMANY WEST CENTRAL DEPLOYMENT
Write-Host "=== AZURE MARKETING AGENTS DEPLOYMENT (Germany West Central) ===" -ForegroundColor Cyan

# ============================================================
# CONFIGURATION
# ============================================================
$LOCATION = "germanywestcentral"   # Frankfurt, Germany
...
Write-Host "Using region: $LOCATION" -ForegroundColor Yellow
...
Write-Host "Region: $LOCATION (Frankfurt, Germany)" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
