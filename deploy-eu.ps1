# deploy-northeurope.ps1 - NORTH EUROPE (IRELAND)
Write-Host "=== AZURE MARKETING AGENTS DEPLOYMENT (North Europe - Ireland) ===" -ForegroundColor Cyan

# ============================================================
# CONFIGURATION
# ============================================================
$LOCATION = "northeurope"   # Dublin, Ireland
...
Write-Host "Using region: $LOCATION (Dublin, Ireland)" -ForegroundColor Yellow
...
Write-Host "Region: $LOCATION (Dublin, Ireland)" -ForegroundColor Cyan
Write-Host "==========================================" -ForegroundColor Cyan
Write-Host ""
